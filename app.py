...
def plotar_grafico(df_ticker, ticker, empresa, rsi, is_val,
    ...
    if timeframe == 'Mensal':
        ...
        axes[2].xaxis.set_major_formatter(mdates.DateFormatter('%d/%b/%y'))
        axes[2].xaxis.set_major_locator(mdates.WeekdayLocator(byweekday=0, interval=4))
    elif timeframe == 'Horário (60min)':
        axes[2].xaxis.set_major_formatter(mdates.DateFormatter('%d/%b'))
        axes[2].xaxis.set_major_locator(mdates.WeekdayLocator(byweekday=0, interval=2))
    else:
        axes[2].xaxis.set_major_formatter(mdates.DateFormatter('%b/%y'))
