        ...
        for col, tela, num, nome, subtitulo in [
            ...
            with col:
                ...
                <div style='background:{bg_s};border:1.5px solid {brd_s};border-radius:10px;
                    ...
                    <div style='font-size:0.68rem;color:{txt_s};margin-bottom:0.4rem;'>
                        {subtitulo}
                    </div>
                    <div style='font-size:1.6rem;margin:0.2rem 0;'>{tela['emoji']}</div>
                    <div style='font-size:0.95rem;font-weight:800;color:{txt_s};'>
                        {tela['status']}
                    </div>
                    {'<div style="font-size:0.75rem;color:'+txt_s+';margin-top:0.2rem;">'+f"Valor: {tela['valor']:,}"+'</div>' if 'valor' in tela else ''}
                </div>""", unsafe_allow_html=True)
